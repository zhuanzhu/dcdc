 ...
 */
@Component
public class ReceiveOrderStockUpdaterFactory<T> 
	 ...
	 */
	@Autowired
	public ReceiveOrderStockUpdaterFactory(
	...
	protected StockUpdater create(List<StorePuWarehouseStockPO> storePuWarehouseStockPOs, 
		...
		return new ReceiveOrderStockUpdater(storePuWarehouseStockPOs, storePuWarehouseStockWriteDAO, 
