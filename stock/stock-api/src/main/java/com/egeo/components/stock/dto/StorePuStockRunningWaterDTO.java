 ...
 */
public class StorePuStockRunningWaterDTO implements Serializable {
	...
	/**
	 * 库存流水类型:1提交订单 2支付 3 取消订单（未支付） 4 取消订单（已支付） 5 进货 6 出货  7签收
	 * @param type 库存流水类型:1提交订单 2支付 3 取消订单（未支付） 4 取消订单（已支付） 5 进货 6 出货  7签收
	 */
