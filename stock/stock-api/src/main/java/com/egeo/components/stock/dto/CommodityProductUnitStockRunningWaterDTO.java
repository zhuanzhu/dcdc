 ...
 */
public class CommodityProductUnitStockRunningWaterDTO implements Serializable {
	...
	public Date getCreateTimeFront() {
		return createTimeFront;
	}

	public void setCreateTimeFront(Date createTimeFront) {
		this.createTimeFront = createTimeFront;
	}

	public Date getCreateTimeBack() {
		return createTimeBack;
	}

	public void setCreateTimeBack(Date createTimeBack) {
	...
	public CommodityProductUnitStockRunningWaterDTO() {
	}

	public CommodityProductUnitStockRunningWaterDTO(String orderCode) {
		this.orderCode = orderCode;
	}
