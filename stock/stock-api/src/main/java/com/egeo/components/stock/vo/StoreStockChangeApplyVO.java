 ...
 * 
 * @author min
 * @date 2018-09-13 16:29:11
 */
public class StoreStockChangeApplyVO implements Serializable {
	 ...
	 * 申请时间开始
	 */
	private Long afterTimeStart;
	/**
	 * 申请时间停止
	 */
	private Long afterTimeStop;

	public Long getAfterTimeStart() {
		return afterTimeStart;
	}

	public void setAfterTimeStart(Long afterTimeStart) {
		this.afterTimeStart = afterTimeStart;
	}

	public Long getAfterTimeStop() {
		return afterTimeStop;
	}

	public void setAfterTimeStop(Long afterTimeStop) {
		this.afterTimeStop = afterTimeStop;
	}

	public String getApplyCauseName() {
		return applyCauseName;
	}

	public void setApplyCauseName(String applyCauseName) {
		this.applyCauseName = applyCauseName;
	}
