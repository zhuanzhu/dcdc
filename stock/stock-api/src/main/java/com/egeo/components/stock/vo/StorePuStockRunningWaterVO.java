 ...
 */
public class StorePuStockRunningWaterVO implements Serializable {
	...
	public Long getCreateTimeStop() {
		return createTimeStop;
	}

	public void setCreateTimeStop(Long createTimeStop) {
