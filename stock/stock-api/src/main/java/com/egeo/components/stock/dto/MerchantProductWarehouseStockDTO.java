 ...
 */
public class MerchantProductWarehouseStockDTO implements Serializable {
	...
	public Long getRealStockNums() {
		return realStockNums;
	}

	public void setRealStockNums(Long realStockNums) {
