...
public class FreeseOrderStockBatchDTO {
	private Long puId; 
	...
	public FreeseOrderStockBatchDTO() {}
	public FreeseOrderStockBatchDTO(Long puId, Integer puCount, String orderCode, Integer type,
