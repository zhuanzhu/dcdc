...
public class SoItemPO implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7257594661067075784L;
	...
	public String toString() {
		return "SoItemPO [id=" + id + ", soChildId=" + soChildId + ", userId=" + userId + ", unitExist=" + unitExist
				+ ", puId=" + puId + ", puCount=" + puCount + ", cartType=" + cartType + ", promotionId=" + promotionId
				+ ", price=" + price + ", promotionAver=" + promotionAver + ", finalPromotionAver=" + finalPromotionAver
				+ ", soId=" + soId + ", updateTime=" + updateTime + ", createTime=" + createTime + ", platformId="
				+ platformId + "]";
	}
