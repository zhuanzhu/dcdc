 ...
 * @Version V1.0
 **/
@Service("oldSyncCreateThirdPartyOrderCakeImpl")
public class OldSyncCreateThirdPartyOrderCakeImpl extends SyncCreateThirdPartyOrderBaseImpl{
    ...
    public JsonResult<SyncCreateThirdPartyOrderRespVO> syncThirdPartyOrder(SyncCreateThirdPartyOrderReqVO reqVO) {
        ...
        try {
            ...
            if(Objects.isNull(submitRT)){
                return JsonResult.fail("当前订单存在蛋糕专卖子订单,订单下单失败,返回无数据");
            }
            //若未取消则订单提交成功
