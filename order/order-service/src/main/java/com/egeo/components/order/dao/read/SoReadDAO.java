...
public interface SoReadDAO extends BaseReadDAO<SoPO>{

	List<SoPO> findAllunpayOrders(@Param("po") SoPO po);
	 ...
	 * @return
	 */
	List<SoPO> querySoListByCondition(
	 ...
	 * @return
	 */
	SoPO querySoByOrderCode(@Param("orderCode")String orderCode);
	 ...
	 * @return
	 */
	SoPO queryUndeleteSoByOrderCode(@Param("orderCode")String orderCode);


	int countOrderOfPage(@Param("po")SoPO po, @Param("cashPayType")Integer cashPayType, @Param("useFubi")Integer useFubi, @Param("startDateTime")Date startDateTime, @Param("endDateTime")Date endDateTime);

	List<SoPO> findOrderOfPage(@Param("po")SoPO po, @Param("cashPayType")Integer cashPayType, @Param("useFubi")Integer useFubi, @Param("startDateTime")Date startDateTime, @Param("endDateTime")Date endDateTime,@Param("page")Pagination page);
     ...
     * */
	List<SoPO> queryBackStageSoPage(
    ...
    Long findSoSum(@Param("soPO") SoPO soPO);

	List<SoPO> findSoByPuId(@Param("puId") Long puId,@Param("orderConfirmStatus") Integer orderConfirmStatus);

	List<SoPO> findSoByPuIds(@Param("puIds") List<Long> puIds,@Param("orderConfirmStatus") Integer orderConfirmStatus);

    SoPO findSoByThirdpartyId(@Param("jdOrderId")String jdOrderId);

   /* List<SoPO> queryBackStageSoPageByStoreIdNull(@Param("storeId")Long storeId,@Param("orderCode") String orderCode,
   ...
   List<SoExtendsCondition> getOrderListByUserAndStatusPage(@Param("page")Pagination page, @Param("po") SoPO po);
   Integer getOrderListByUserAndStatusCount(@Param("po") SoPO po);

	List<SoPO> getSoByIds(@Param("ids") List<Long> ids);
}
