 ...
 * @Version V1.0
 **/
public class PushOrderRequestExtVO  implements Serializable {
    ...
    List<PushChildOrderExtVO> childOrder;



    public PushOrderRequestExtVO() {
    }

    public PushOrderRequestExtVO(SoDTO soDTO){
    ...
    public List<PushChildOrderExtVO> getChildOrder() {
        return childOrder;
    }

    public void setChildOrder(List<PushChildOrderExtVO> childOrder) {
