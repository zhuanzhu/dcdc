...
public class Traces implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6420115201398156470L;
	...
	private String preOrNextIsCenter;
	...
	public String getPreOrNextIsCenter() {
		return preOrNextIsCenter;
	}

	public void setPreOrNextIsCenter(String preOrNextIsCenter) {
		this.preOrNextIsCenter = preOrNextIsCenter;
	}
