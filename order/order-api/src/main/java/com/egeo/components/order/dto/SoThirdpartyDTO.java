 ...
 * 
 * @author wyy
 * @date 2018-06-08 11:21:07
 */
public class SoThirdpartyDTO implements Serializable {
	...
	/**
	 * 第三方订单状态  -1:新增状态(未支付) 0:处理中  1:成功  2:失败
	 */
	...
	/**
	 * 第三方订单状态   0:处理中  1:成功  2:失败
	 * @param thirdpartyStatus 第三方订单状态   -1:新增状态(未支付) 0:处理中  1:成功  2:失败
	 */
