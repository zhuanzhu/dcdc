 ...
 */
public class CustomerConditionDTO implements Serializable {
	 ...
	 * 公司配置id
	 */
	private Long platfromConditionId;	
	 ...
	 * 是否启用默认0可编辑 1不可编辑
	 */
	private Integer defualtCondition;	

	/**
	 * 用户自定义显示别名(一般用户lable、span等等)
	 */
	 ...
	 * 公司是否启用默认0启用 1禁用
	 */
	private Integer platfromActive;	
	 ...
	 * @return 公司配置id
	 */
	public Long getPlatfromConditionId() {
		return platfromConditionId;
	}

	/**
	 * 公司配置id
	 * @param platfromConditionId 公司配置id
	 */
	public void setPlatfromConditionId(Long platfromConditionId) {
		this.platfromConditionId = platfromConditionId;
	}
	/**
	 * 菜单code
	 * @return 菜单code
	...
	/**
	 * 是否启用默认0可编辑 1不可编辑
	 * @return 是否启用默认0可编辑 1不可编辑
	 */
	public Integer getDefualtCondition() {
		return defualtCondition;
	}

	/**
	 * 是否启用默认0可编辑 1不可编辑
	 * @param defualtCondition 是否启用默认0可编辑 1不可编辑
	 */
	public void setDefualtCondition(Integer defualtCondition) {
		this.defualtCondition = defualtCondition;
	}
	/**
	 * 用户自定义显示别名(一般用户lable、span等等)
	 * @return 用户自定义显示别名(一般用户lable、span等等)
	 */
	...
	/**
	 * 用户自定义显示别名(一般用户lable、span等等)
	 * @param viewAliasName 用户自定义显示别名(一般用户lable、span等等)
	 */
	...
	/**
	 * 公司是否启用默认0启用 1禁用
	 * @return 公司是否启用默认0启用 1禁用
	 */
	public Integer getPlatfromActive() {
		return platfromActive;
	}

	/**
	 * 公司是否启用默认0启用 1禁用
	 * @param platfromActive 公司是否启用默认0启用 1禁用
	 */
	public void setPlatfromActive(Integer platfromActive) {
		this.platfromActive = platfromActive;
	}
	/**
	 * 是否默认 0:否,1:是
	 * @return 是否默认 0:否,1:是
