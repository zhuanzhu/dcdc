...
public class InvoiceVO implements Serializable {
	...
	public Integer getIsFullInfo() {
		if (registerAddr != null && !registerAddr.trim().equals("")
				&& registerTel != null && !registerTel.trim().equals("")
				&& depositBank != null && !depositBank.trim().equals("")
				&& bankAccount != null && !bankAccount.trim().equals("")
				&& businessLicenceUrl != null && !businessLicenceUrl.trim().equals("")) {
