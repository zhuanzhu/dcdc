 ...
 * 
 * @author xiaping
 * @date 2017-08-24 17:02:54
 */
public class SoExchangeItemVO implements Serializable {
	 ...
	 * @return 换货id
	 */
	public Long getSoExchangeId() {
		return soExchangeId;
	}

	/**
	 * 换货id
	 * @param soExchangeId 换货id
	 */
	public void setSoExchangeId(Long soExchangeId) {
		this.soExchangeId = soExchangeId;
	}	
	/**
	 * 订单编号
	 * @return 订单编号
