 ...
 * @Version V1.0
 **/
public class PushChildOrderVO implements Serializable {
     ...
     * 推送的商品信息
     **/
    private List<PushOrderProductVO> product;
    ...
    public List<PushOrderProductVO> getProduct() {
        return product;
    }

    public void setProduct(List<PushOrderProductVO> product) {
