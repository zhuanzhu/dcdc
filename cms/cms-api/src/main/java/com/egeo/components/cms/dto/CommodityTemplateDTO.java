 ...
 */
public class CommodityTemplateDTO implements Serializable {
	...
	/**
	 * 模版类型：1、电子卡券模板 2、实物商品模版 
	 * @param templateType 模版类型：1、电子卡券模板 2、实物商品模版 
	 */
