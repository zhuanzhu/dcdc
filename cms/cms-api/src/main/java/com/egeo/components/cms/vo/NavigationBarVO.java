...
public class NavigationBarVO implements Serializable {
	...
	private List<NavigationLabelSimpleVO> navigationLabelList;	// 导航栏标签的集合
	...
	public List<NavigationLabelSimpleVO> getNavigationLabelList() {
		return navigationLabelList;
	}

	public void setNavigationLabelList(List<NavigationLabelSimpleVO> navigationLabelList) {
