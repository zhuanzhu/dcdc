 ...
 */
@Service
public class RmbConvertYToFRuteStrategy implements FieldsFormatRuteService {

	@Override
	public String getRuteName() {
		return RuteNameEnum.RUTE_NAME_RMB_Y_TO_F.getRuteName();
	}
	...
	public Object formatValues(Object vaule, FieldRuteInfo fundRuteInfo){
		...
		String result = BigDecimalUtils.rmbConvertYoF(vaule.toString());
