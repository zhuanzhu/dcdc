...
public class ECardPO {
	 ...
	 * 是否分配：0否、1是
	 */
	private Integer isAllocation = 0;	
	 ...
	 * 搜索开始时间区间、结束时间区间
	 */
	private Date startTimeBegin,startTimeFinish,endTimeBegin,endTimeFinish;
	/**
	 * 创建时间搜索区间
	 */
	private Date createTimeBegin,createTimeFinish;
	/**
	 * 分配搜索区间
	 */
	private Date allocationTimeBegin,allocationTimeFinish;
	...
	public Date getAllocationTimeBegin() {
		return allocationTimeBegin;
	}

	public void setAllocationTimeBegin(Date allocationTimeBegin) {
		this.allocationTimeBegin = allocationTimeBegin;
	}

	public Date getAllocationTimeFinish() {
		return allocationTimeFinish;
	}

	public void setAllocationTimeFinish(Date allocationTimeFinish) {
		this.allocationTimeFinish = allocationTimeFinish;
	}
	...
	public Date getStartTimeFinish() {
		return startTimeFinish;
	}

	public void setStartTimeFinish(Date startTimeFinish) {
		this.startTimeFinish = startTimeFinish;
	}
	...
	public Date getEndTimeFinish() {
		return endTimeFinish;
	}

	public void setEndTimeFinish(Date endTimeFinish) {
		this.endTimeFinish = endTimeFinish;
	}
