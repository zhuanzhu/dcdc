package com.egeo.components.finance.filter;
...
public class GlobalExceptionAspect {
	...
	public JsonResult errorHandler(Exception e) {
		...
		}else if(e instanceof com.egeo.components.finance.common.BusinessException) {
			com.egeo.components.finance.common.BusinessException se = (com.egeo.components.finance.common.BusinessException) e;
			return JsonResult.fail(se.getMessage(),se.getErrNo());
		}else{
			logger.error("系统异常",e);
