...
public interface ProductAttValueWriteService {

    Long saveProductAttValueWithTx(ProductAttValueDTO dto);

    String deleteByProductAttNameIdWithTx(ProductAttValueDTO dto);
	 ...
	 * @return
	 */
	int deleteByIdWithTx(ProductAttValueDTO dto,Long productId);
	/**
     ...
     * @return
     */
	Long saveProductAttValueByProductIdAndAttnameIdWithTx(Long productId, List<ProductAttValueDTO> dto, Long platformId);
	/**
