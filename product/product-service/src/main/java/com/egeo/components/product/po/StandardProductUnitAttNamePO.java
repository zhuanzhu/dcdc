 ...
 */
public class StandardProductUnitAttNamePO {
	...
	private List<StandardProductUnitAttValuePO> standardProductUnitAttValueList;
	...
	public List<StandardProductUnitAttValuePO> getStandardProductUnitAttValueList() {
		return standardProductUnitAttValueList;
	}

	public void setStandardProductUnitAttValueList(List<StandardProductUnitAttValuePO> standardProductUnitAttValueList) {
