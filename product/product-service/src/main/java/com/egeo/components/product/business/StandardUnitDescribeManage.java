...
public interface StandardUnitDescribeManage {
	...
	Long insertStandardUnitDescribeWithTx(StandardUnitDescribeDTO dto);

	int updateStandardUnitDescribeWithTx(StandardUnitDescribeDTO dto);

	int deleteStandardUnitDescribeWithTx(StandardUnitDescribeDTO dto);
	/**
	 * 根据su商品id查询su商品星详情
