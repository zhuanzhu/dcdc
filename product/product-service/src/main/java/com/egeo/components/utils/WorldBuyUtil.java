...
public class WorldBuyUtil {
    ...
    private String worldAppId="f";

    private String worldKey="faa";

    private final static String ENCODE_UTF="UTF-8";

    private String requestBaseUrl="http://198.149.2.3:801/Queryapi/index";
    ...
    public static void main(String[] args) {
        ...
        param.put("eeee","成功");
        String sourceSign = worldBuyUtil.getSign(param);
        String jsonString = worldBuyUtil.getUrlEnCode(JSON.toJSONString(param));
        boolean checkSignRt = worldBuyUtil.checkSign(jsonString,sourceSign);
        System.out.println(checkSignRt);
    }
    ...
    private Map<String,Object> getRequestParamMap(Map<String,Object> paramMap,String requestMethod){
        String paramString = getSign(paramMap);
        Map<String,Object> requestMap = new HashMap<>();
        requestMap.put("appid",this.worldAppId);
        requestMap.put("requestMethod",requestMethod);
        requestMap.put("requestData", CollectionUtils.isEmpty(paramMap)?"":getUrlEnCode(JSON.toJSONString(paramMap)));
        requestMap.put("sign", paramString);
        return requestMap;
    }

    private String getSign(Map<String,Object> paramMap){
        String keyValueString = sortMapToKeyValue(paramMap);
