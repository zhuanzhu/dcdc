 ...
 */
public class ProductAttValueDTO implements Serializable {
	...
	public Long getProductAttNameId() {
		return productAttNameId;
	}

	/**
	 * 
	 * @param productAttNameId 
	 */
	public void setProductAttNameId(Long productAttNameId) {
		this.productAttNameId = productAttNameId;
	}
	/**
	 * 
	 * @return 
