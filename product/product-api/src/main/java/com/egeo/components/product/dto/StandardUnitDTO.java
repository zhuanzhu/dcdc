 ...
 */
public class StandardUnitDTO implements Serializable {
	...
	public static boolean isJd(Integer sourcee) {
		return sourcee!=null && sourcee.intValue()==3;
	}
