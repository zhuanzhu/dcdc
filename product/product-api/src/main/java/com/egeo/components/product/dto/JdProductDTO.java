...
public class JdProductDTO implements Serializable {
	...
	private Long innerCategoryTreeNode;
	...
	private BigDecimal customProfit;
	...
	public Long getInnerCategoryTreeNode() {
		return innerCategoryTreeNode;
	}

	public void setInnerCategoryTreeNode(Long innerCategoryTreeNode) {
		this.innerCategoryTreeNode = innerCategoryTreeNode;
	}

	public String getInnerCategorySerialNumber() {
		return innerCategorySerialNumber;
	}

	public void setInnerCategorySerialNumber(String innerCategorySerialNumber) {
		this.innerCategorySerialNumber = innerCategorySerialNumber;
	}
	...
	private String innerCategorySerialNumber;
	...
	public String getIntroduction() {
		return introduction==null?"":introduction.replace("width:750px", "width:100%");
	}
	...
	public void setPrice(BigDecimal price) {
		...
		if(priceStr.indexOf(".")>0 && (priceStr.indexOf(".")+3)<=priceStr.length()) {
			this.price = new BigDecimal(priceStr.substring(0, priceStr.indexOf(".")+3));
		}else {
			this.price = price;
		}
	}
	...
	public void setMarketPrice(BigDecimal marketPrice) {
		...
		String priceStr = marketPrice.toPlainString();
		if(priceStr.indexOf(".")>0 && (priceStr.indexOf(".")+3)<=priceStr.length()) {
			this.marketPrice = new BigDecimal(priceStr.substring(0, priceStr.indexOf(".")+3));
		}else {
	...
	public Integer standardUnitState() {
		return (state!=null && state.intValue()==1)?3:4;
	}
	...
	public BigDecimal getCustomProfit() {
		return customProfit;
	}

	public void setCustomProfit(BigDecimal customProfit) {
		if (Objects.isNull(customProfit)){
			return;
		}
		this.customProfit = customProfit.setScale(2, BigDecimal.ROUND_HALF_UP);
	}
