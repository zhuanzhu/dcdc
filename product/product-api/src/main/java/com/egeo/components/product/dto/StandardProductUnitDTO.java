 ...
 */
public class StandardProductUnitDTO implements Serializable {
	private static final long serialVersionUID = 1L;

	public Integer getThirdpartyAtt() {
		return thirdpartyAtt;
	}

	public void setThirdpartyAtt(Integer thirdpartyAtt) {
		this.thirdpartyAtt = thirdpartyAtt;
	}

private List<Map<Long,String>> merchantMapList;

	public List<Map<Long, String>> getMerchantMapList() {
		return merchantMapList;
	}

	public void setMerchantMapList(List<Map<Long, String>> merchantMapList) {
		this.merchantMapList = merchantMapList;
	}

	/**
	 * 第三方对接参数
	 */
	private Integer thirdpartyAtt;
     ...
     * 轮播图片集合
     */
    private List<String> pictureDTOs;
	...
	public List<String> getPictureDTOs() {
		return pictureDTOs;
	}

	public void setPictureDTOs(List<String> pictureDTOs) {
