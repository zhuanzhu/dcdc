...
public class JdCategoryDTO implements Serializable {
	...
	private List<JdCategoryDTO> categoryDTOList;

	public List<JdCategoryDTO> getCategoryDTOList() {
		return categoryDTOList;
	}

	public void setCategoryDTOList(List<JdCategoryDTO> categoryDTOList) {
