...
public class SkuDTO implements Serializable {
	...
	private String synchronizationString;
	/**
	 * 是否有效
	 */
	...
	public String getSynchronizationString() {
		return synchronizationString;
	}

	public void setSynchronizationString(String synchronizationString) {
		this.synchronizationString = synchronizationString;
	}
	...
	public void setIsValidString(String isValidString) {
