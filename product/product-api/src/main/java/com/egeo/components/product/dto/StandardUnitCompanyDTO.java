 ...
 */
public class StandardUnitCompanyDTO implements Serializable {
	...
	private List<Long> standardUnitIds;
	/**
	 * 公司id
	 */
	...
	public List<Long> getStandardUnitIds() {
		return standardUnitIds;
	}

	public void setStandardUnitIds(List<Long> standardUnitIds) {
		this.standardUnitIds = standardUnitIds;
	}
}
