...
public class MerchantProductDTO implements Serializable {
	...
	private Integer jdProfit;

	public Integer getJdProfit() {
		return jdProfit;
	}

	public void setJdProfit(Integer jdProfit) {
		this.jdProfit = jdProfit;
	}
	...
	/**
	 * 商品状态（1、草稿 3、已上架 4、已下架 ）
	 */
	private Integer suStatus = 1;	
	 ...
	 * 总店门店码
	 */
	private String headActivityCode;
	...
	public String getHeadActivityCode() {
		return headActivityCode;
	}

	public void setHeadActivityCode(String headActivityCode) {
		this.headActivityCode = headActivityCode;
	}
