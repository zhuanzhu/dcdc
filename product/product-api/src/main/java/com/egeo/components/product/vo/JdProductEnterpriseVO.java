 ...
 */
public class JdProductEnterpriseVO implements Serializable {
	...
	public void setSalePrice(BigDecimal salePrice) {
		this.salePrice = salePrice.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString();;
	}	
	...
	public void setProfit(BigDecimal profit) {
		this.profit = profit.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString();
	}
	...
	public void setPrice(BigDecimal price) {
		this.price = price.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString();
	}	
	/**
	 * 市场价格
	 * @return 市场价格
	...
	public void setMarketPrice(BigDecimal marketPrice) {
		this.marketPrice = marketPrice.setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString();
	}	
	/**
	 * 是否自营 0-否 1-是
	 * @return 是否自营 0-否 1-是
