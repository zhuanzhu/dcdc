...
@FeignClient(name = "service-user-fgj",contextId="InfoTemplateClient")
public interface InfoTemplateClient {

	@RequestMapping(value = { "/client/user/infoTemplate/findUserInfoForMsgBox" }, method = { RequestMethod.POST }) 
