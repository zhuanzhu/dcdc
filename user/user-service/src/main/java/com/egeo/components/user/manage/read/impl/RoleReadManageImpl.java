...
import com.egeo.components.user.manage.read.RoleReadManage;
...
public class RoleReadManageImpl implements RoleReadManage {
	...
	@Override
	public RolePO findRoleByRoleNamePlatformId(String name,Long platformId) {
	...
	public List<RolePO> findAll(RolePO po) {
		...
		return roleReadDAO.findAll(po,null);
	}
